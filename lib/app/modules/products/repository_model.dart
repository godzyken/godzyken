...
class Repository {
  ...
  Repository.fromJson(Map<String, dynamic> json) {
    ...
    htmlUrl = htmlUrl ?? json['htmlUrl'];
    description = description ?? json['description'];
    fork = fork ?? json['fork'];
    url = url ?? json['url'];
    forksUrl = forksUrl ?? json['forksUrl'];
    keysUrl = keysUrl ?? json['keysUrl'];
    collaboratorsUrl = collaboratorsUrl ?? json['collaboratorsUrl'];
    teamsUrl = teamsUrl ?? json['teamsUrl'];
    hooksUrl = hooksUrl ?? json['hooksUrl'];
    issueEventsUrl = issueEventsUrl ?? json['issueEventsUrl'];
    eventsUrl = eventsUrl ?? json['eventsUrl'];
    assigneesUrl = assigneesUrl ?? json['assigneesUrl'];
    branchesUrl = branchesUrl ?? json['branchesUrl'];
    tagsUrl = tagsUrl ?? json['tagsUrl'];
    blobsUrl = blobsUrl ?? json['blobsUrl'];
    gitTagsUrl = gitTagsUrl ?? json['gitTagsUrl'];
    gitRefsUrl = gitRefsUrl ?? json['gitRefsUrl'];
    treesUrl = treesUrl ?? json['treesUrl'];
    statusesUrl = statusesUrl ?? json['statusesUrl'];
    languagesUrl = languagesUrl ?? json['languagesUrl'];
    stargazersUrl = stargazersUrl ?? json['stargazersUrl'];
    contributorsUrl = contributorsUrl ?? json['contributorsUrl'];
    subscribersUrl = subscribersUrl ?? json['subscribersUrl'];
    subscriptionUrl = subscriptionUrl ?? json['subscriptionUrl'];
    commitsUrl = commitsUrl ?? json['commitsUrl'];
    gitCommitsUrl = gitCommitsUrl ?? json['gitCommitsUrl'];
    commentsUrl = commentsUrl ?? json['commentsUrl'];
    issueCommentUrl = issueCommentUrl ?? json['issueCommentUrl'];
    contentsUrl = contentsUrl ?? json['contentsUrl'];
    compareUrl = compareUrl ?? json['compareUrl'];
    mergesUrl = mergesUrl ?? json['merges_url'];
    archiveUrl = archiveUrl ?? json['archive_url'];
    downloadsUrl = downloadsUrl ?? json['downloads_url'];
    issuesUrl = issuesUrl ?? json['issues_url'];
    pullsUrl = pullsUrl ?? json['pulls_url'];
    milestonesUrl = milestonesUrl ?? json['milestones_url'];
    notificationsUrl = notificationsUrl ?? json['notifications_url'];
    labelsUrl = labelsUrl ?? json['labels_url'];
    releasesUrl = releasesUrl ?? json['releases_url'];
    deploymentsUrl = deploymentsUrl ?? json['deployments_url'];
    createdAt = createdAt ?? json['created_at'];
    updatedAt = updatedAt ?? json['updated_at'];
    pushedAt = pushedAt ?? json['pushed_at'];
    gitUrl = gitUrl ?? json['git_url'];
    sshUrl = sshUrl ?? json['ssh_url'];
    cloneUrl = cloneUrl ?? json['clone_url'];
    svnUrl = svnUrl ?? json['svn_url'];
    homepage = homepage ?? json['homepage'];
    size = size ?? json['size'];
    stargazersCount = stargazersCount ?? json['stargazers_count'];
    watchersCount = watchersCount ?? json['watchers_count'];
    language = language ?? json['language'];
    hasIssues = hasIssues ?? json['has_issues'];
    hasProjects = hasProjects ?? json['has_projects'];
    hasDownloads = hasDownloads ?? json['has_downloads'];
    hasWiki = hasWiki ?? json['has_wiki'];
    hasPages = hasPages ?? json['has_pages'];
    ...
    openIssuesCount = openIssuesCount ?? json['open_issues_count'];
    license = license ?? json['license'];
    allowForking = allowForking ?? json['allow_forking'];
    isTemplate = isTemplate ?? json['is_template'];
    visibility = visibility ?? json['visibility'];
    forks = forks ?? json['forks'];
    openIssues = openIssues ?? json['open_issues'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['teamsUrl'] =  teamsUrl ?? teamsUrl;
...
class Owner {
  ...
  Owner.fromJson(Map<String, dynamic> json) {
    ...
    url = url ?? json['url'];
    htmlUrl = htmlUrl ?? json['htmlUrl'];
    followersUrl = followersUrl ?? json['followers_url'];
    followingUrl = followingUrl ?? json['following_url'];
    gistsUrl = gistsUrl ?? json['gists_url'];
    starredUrl = starredUrl ?? json['starred_url'];
    subscriptionsUrl = subscriptionsUrl ?? json['subscriptions_url'];
    organizationsUrl = organizationsUrl ?? json['organizations_url'];
    reposUrl = reposUrl ?? json['repos_url'];
    eventsUrl = eventsUrl ?? json['eventsUrl'];
    receivedEventsUrl = receivedEventsUrl ?? json['received_events_url'];
    type = type ?? json['type'];
    siteAdmin = siteAdmin ?? json['site_admin'];
  }
